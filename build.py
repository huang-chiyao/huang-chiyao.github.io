...
def get_personal_data():
    ...
    bio_text = f"""
                ...
                <p>
                    <a href="https://github.com/huang-chiyao/cyhuang.github.io/assets/pdf/CV.pdf" target="_blank" style="margin-right: 15px"><i class="fa fa-address-card fa-lg"></i> CV</a>
