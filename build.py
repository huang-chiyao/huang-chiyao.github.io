...
def get_personal_data():
    ...
    bio_text = f"""
        ...
        <p style="text-align: justify;">
            ...
            at the School of Computing and Augmented Intelligence, Arizona State University.
    ...
    <div class="container">
        <div class="row" style="margin-top: 3em;">
            ...
            <div class="col-md-4" style="">
                <div class="mx-auto" style="width: 280px; height: 280px; overflow: hidden; border-radius: 50%; border: 1px solid #ddd;">
